...
export const CITIES: City[] = [
  ...
  },
  {
    ...
    food_intro:
      "Shanghai's food scene blends rich Jiangnan traditions with global influences. Known for sweet-savory braised pork, xiao long bao, hairy crab in autumn, and a thriving international dining landscape.",
  },
  {
    id: "beijing",
    name_en: "Beijing",
